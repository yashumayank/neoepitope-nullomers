...
sort TSNAdb_ICGC_neoepitopes-nullomersEdge6.tsv|uniq | awk -F "\t" '(NR==FNR){hla[$4"_"$10"->"$14]=$9; wt[$4"_"$10"->"$14]=$11; neo[$4"_"$10"->"$14]=$16;next}{OFS="\t";print $0"\t"hla[$4"_"$3] "\t" wt[$4"_"$3] "\t" neo[$4"_"$3]}' TSNAdb_frequent_neoantigen_ICGC_4.0_adj.txt - > TSNAdb_ICGC_neoepitopes-nullomers.filtered.tsv
sort TSNAdb_TCGA_neoepitopes-nullomersEdge6.tsv|uniq | awk -F "\t" '(NR==FNR){hla[$4"_"$10"->"$14]=$9; wt[$4"_"$10"->"$14]=$11; neo[$4"_"$10"->"$14]=$16;next}{OFS="\t";print $0"\t"hla[$4"_"$3] "\t" wt[$4"_"$3] "\t" neo[$4"_"$3]}' TSNAdb_frequent_neoantigen_TCGA_4.0_adj.txt - > TSNAdb_TCGA_neoepitopes-nullomers.filtered.tsv
